...
class ChatReadRetrieveReadApproach(Approach):
    ...
    """
    system_message_chat_conversation = """You are a customer facing assistant for a company called Expert Thinking. You should be polite but have the aim of selling professional services. 
{follow_up_questions_prompt}
{injected_prompt}
"""
    follow_up_questions_prompt_content = "Make sure to refer any potential customers to sales@expert-thinking.co.uk"

    query_prompt_template = """Below is a history of the conversation so far, and a new question asked by the user that needs to be answered by searching in a knowledge base about Expert Thinking customer or employees.
...
"""
    query_prompt_few_shots = [
        {"role": USER, "content": "Who are ET?"},
        {"role": ASSISTANT, "content": "What tech do they use?"},
        {"role": USER, "content": "can they help me?"},
        {"role": ASSISTANT, "content": "who can I contact?"},
    ]
        ...
        functions = [
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "search_query": {
                            "type": "string",
                            "description": "Query string to retrieve documents from azure search eg: 'Customers'",
                        }
                    },
